...
***/
    ...
    try {
        ...
        var netBuilder = Java.use("com.ttnet.org.chromium.net.CronetEngine$Builder");
        ...
        console.log('[-] Cronet(Tiktok) pinner not found')
    }
...
Interceptor.attach(Module.findExportByName("libc.so", "dlsym"), {
    ...
    onLeave: function (ret) {
        ...
        if (module && this.on_load) {
            if (module.name == "libttboringssl.so") {



                Interceptor.attach(Module.findExportByName("libttboringssl.so", "SSL_CTX_set_custom_verify"),
                    {
                        onEnter: function (args) {
                            console.log("Inside Native Function onEnter SSL_CTX_set_custom_verify");

                            console.log('Context information:');
                            console.log('Context  : ' + JSON.stringify(this.context));
                            console.log('Return   : ' + this.returnAddress);

                            this.context.x1 = 0x00;
                ...
                Interceptor.attach(Module.findExportByName("libttboringssl.so", "SSL_set_custom_verify"),
                    {
                        onEnter: function (args) {
                            console.log("Inside Native Function onEnter SSL_set_custom_verify");
                ...
                Interceptor.attach(Module.findExportByName("libttboringssl.so", "SSL_set_verify"),
                    {
                        onEnter: function (args) {
                            console.log("Inside Native Function onEnter SSL_set_verify");
                            console.log('Context information:');
                            console.log('Context  : ' + JSON.stringify(this.context));
                            console.log('Return   : ' + this.returnAddress);
                ...
                Interceptor.attach(Module.findExportByName("libttboringssl.so", "SSL_CTX_set_verify"),
                    {
                        onEnter: function (args) {
                            console.log("Inside Native Function onEnter SSL_CTX_set_verify");
